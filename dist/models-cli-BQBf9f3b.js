...
import { t as ensureOpenClawModelsJson } from "./models-config-BCmOQwo3.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-DR4RSBMd.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-ypkxllDe.js";
...
import { r as resolveForwardCompatModel } from "./model-CW_UpJO9.js";
...
import { r as withProgressTotals } from "./progress-C8EQAwBh.js";
...
import { f as openUrl } from "./onboard-helpers-BBIZ51oD.js";
...
import { n as redactSecrets } from "./format-BA5BpPBi.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-BeEG6ZLV.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-zbDvSlSr.js";
import { n as logConfigUpdated } from "./logging-qb4rMXSH.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-Bgd1ImHe.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./model-selection-CTrlAwmO.js").then((n) => n.Pt);
	const { ensureAuthProfileStore } = await import("./model-selection-CTrlAwmO.js").then((n) => n.ct);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CW_UpJO9.js").then((n) => n.t);
