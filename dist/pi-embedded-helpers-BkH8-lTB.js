import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-DT-163rP.js";
import { K as truncateUtf16Safe, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger, z as resolveUserPath } from "./subsystem-CMcdOpPO.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-BR4maq1j.js";
import { d as resolveSessionAgentId, r as resolveAgentConfig } from "./agent-scope-BQNab8SK.js";
import { _ as runExec, a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_USER_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, k as resolvePathViaExistingAncestorSync, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME, w as openBoundaryFile } from "./workspace-CHmqKFRC.js";
import { $ as getBlockedNetworkModeReason, H as writeConfigFile, L as createConfigIO, R as loadConfig } from "./model-selection-BePWPcm7.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CQewn6Y8.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CQewn6Y8.js")).closePlaywrightBrowserConnection();
		} catch {}
