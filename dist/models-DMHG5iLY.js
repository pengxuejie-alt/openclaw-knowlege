...
import { i as toAgentModelListLike, n as resolveAgentModelFallbackValues, r as resolveAgentModelPrimaryValue } from "./model-input-DkokhB4_.js";
import { A as resolveDefaultAgentWorkspaceDir, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-DIyeRIwV.js";
import { r as resolveForwardCompatModel } from "./model-B0KrJA7k.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-oH9Hk1Gw.js";
import { Sn as maskApiKey, bn as formatUsageWindowSummary, en as DEFAULT_OAUTH_WARN_MS, nn as formatRemainingShort, s as runEmbeddedPiAgent, tn as buildAuthHealthSummary, vn as loadProviderUsageSummary, wt as describeFailoverError, xn as resolveUsageProviderId } from "./subagent-registry-tIcCr1XE.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-BvPCP-jf.js";
import { t as ensureOpenClawModelsJson } from "./models-config-ChKtmyem.js";
import { n as loadModelCatalog } from "./model-catalog-DdcLYAX5.js";
import { r as withProgressTotals } from "./progress-CrCu56Pm.js";
import { f as openUrl } from "./onboard-helpers-B0Dw__Bi.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-Cg8yEoyW.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BGMIYybd.js";
import { n as logConfigUpdated } from "./logging-DEdvCpbB.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-DtHYZiEG.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./auth-profiles-0NafhXwT.js").then((n) => n.D);
	const { ensureAuthProfileStore } = await import("./auth-profiles-0NafhXwT.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-B0KrJA7k.js").then((n) => n.t);
