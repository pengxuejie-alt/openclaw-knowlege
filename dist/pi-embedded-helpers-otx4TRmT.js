import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-CooyrpXL.js";
import { K as truncateUtf16Safe, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger, z as resolveUserPath } from "./subsystem-BXVThTnS.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-BR4maq1j.js";
import { D as runExec, P as openBoundaryFile, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME, z as resolvePathViaExistingAncestorSync } from "./agent-scope-BWYUfj03.js";
import { I as createConfigIO, L as loadConfig, Q as getBlockedNetworkModeReason, V as writeConfigFile } from "./model-selection-D_iCxsDp.js";
import { n as parseBooleanValue, r as formatCliCommand } from "./env-7gvr9XcN.js";
import { t as generateSecureToken } from "./secure-random-aFAMbHUC.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-wCrItz9h.js";
import { B as DEFAULT_BROWSER_EVALUATE_ENABLED, C as ensureChromeExtensionRelayServer, D as DEFAULT_TRACE_DIR, E as DEFAULT_DOWNLOAD_DIR, H as DEFAULT_OPENCLAW_BROWSER_ENABLED, I as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, L as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, N as normalizeBrowserFormField, O as DEFAULT_UPLOAD_DIR, P as isLoopbackHost, R as DEFAULT_AI_SNAPSHOT_MAX_CHARS, U as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, V as DEFAULT_OPENCLAW_BROWSER_COLOR, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as resolveWritablePathWithinRoot, k as resolveExistingPathsWithinRoot, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson, z as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME } from "./chrome-Dqo4SJAC.js";
import { t as SsrFBlockedError } from "./ssrf-GR1wTjsC.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-DPQbg2ES.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-Cgk53A10.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-BNFMVSQh.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-Ba77BlnR.js";
import { H as resolveAgentMainSessionKey, V as canonicalizeMainSessionAlias, q as acquireSessionWriteLock } from "./sessions-BW7zDpIh.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-By6DFC0G.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CRRWKvaA.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CRRWKvaA.js")).closePlaywrightBrowserConnection();
		} catch {}
