...
import { Kt as splitShellArgs, j as loadConfig, rt as parseDurationMs } from "./auth-profiles-0NafhXwT.js";
...
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-X3vbva0F.js";
import { t as formatDocsLink } from "./links-BXWkrGr8.js";
import { r as withManager } from "./cli-utils-BlFG2Sa_.js";
import { t as formatHelpExamples } from "./help-format-GFuiXY9-.js";
import { n as withProgress, r as withProgressTotals } from "./progress-CrCu56Pm.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-DI7R8nJK.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-BVaYZmCG.js").then((n) => n.t);
