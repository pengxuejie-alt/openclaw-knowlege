...
import { n as loadConfig, o as writeConfigFile, t as createConfigIO, z as getBlockedNetworkModeReason } from "./config-BoilMlyN.js";
...
import { D as runExec, P as openBoundaryFile, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME, z as resolvePathViaExistingAncestorSync } from "./agent-scope-CaSC-F0Q.js";
import { A as acquireSessionWriteLock, H as canonicalizeMainSessionAlias, U as resolveAgentMainSessionKey } from "./sessions-CVjUfM8c.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-Cp45HswL.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-YX1NmgDL.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-BFwv1Vgz.js";
import { t as SsrFBlockedError } from "./ssrf-BnbpZtKD.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-BfzZwop2.js";
import { a as syncSkillsToWorkspace, h as safeEqualSecret, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-CzL77Q-C.js";
import { A as resolveWritablePathWithinRoot, B as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, C as ensureChromeExtensionRelayServer, D as DEFAULT_UPLOAD_DIR, E as DEFAULT_TRACE_DIR, F as DEFAULT_AI_SNAPSHOT_MAX_CHARS, I as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, L as DEFAULT_BROWSER_EVALUATE_ENABLED, M as normalizeBrowserFormField, N as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, O as resolveExistingPathsWithinRoot, P as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, R as DEFAULT_OPENCLAW_BROWSER_COLOR, T as DEFAULT_DOWNLOAD_DIR, V as isLoopbackHost, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson, z as DEFAULT_OPENCLAW_BROWSER_ENABLED } from "./chrome-DpIO-lTH.js";
import { i as saveMediaBuffer, t as ensureMediaDir } from "./store-CbJtVMcX.js";
import { o as normalizeThinkLevel } from "./thinking-BubZBaau.js";
import { t as generateSecureToken } from "./secure-random-Dahcv5Id.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BbVK00rx.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-BbVK00rx.js")).closePlaywrightBrowserConnection();
		} catch {}
