...
import { f as defaultRuntime, p as restoreTerminalState } from "./subsystem-DFF5bJzM.js";
...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BBIZ51oD.js";
...
import { t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-B5tzhdr-.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-C25G4FHL.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BlDoQCTf.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-DZmGbAQ4.js").then((n) => n.i);
